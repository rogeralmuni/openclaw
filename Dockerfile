...
RUN --mount=type=cache,id=s/6416f477-641a-4809-87f2-06f6b2f6ad20-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store,sharing=locked \
...
RUN --mount=type=cache,id=s/6416f477-641a-4809-87f2-06f6b2f6ad20-/var/cache/apt,target=/var/cache/apt,sharing=locked \
    --mount=type=cache,id=s/6416f477-641a-4809-87f2-06f6b2f6ad20-/var/lib/apt,target=/var/lib/apt,sharing=locked \
    apt-get update && \
...
#
# Railway may inject a runtime port (e.g. via OPENCLAW_GATEWAY_PORT/PORT),
# so the healthcheck must not hardcode the gateway port.
